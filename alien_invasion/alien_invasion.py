...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Change the path to where the images are stored
        self.icon_image = pygame.image.load('C:\\Users\\John\\Desktop\\Coding\\Python Work\\alien_invasion\\images\\alien.bmp')
